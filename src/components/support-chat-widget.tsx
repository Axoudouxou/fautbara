    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-[calc(theme(spacing.32)+env(safe-area-inset-bottom))] right-4 z-50 flex size-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-[var(--shadow-card)] transition-transform hover:scale-105 md:bottom-6"
        >
      ...
      {open && (
        <div className="fixed bottom-[calc(theme(spacing.32)+env(safe-area-inset-bottom))] right-4 z-50 flex max-h-[70vh] w-[min(22rem,calc(100vw-2rem))] flex-col overflow-hidden rounded-3xl border border-border bg-card shadow-[var(--shadow-card)] md:bottom-6">
