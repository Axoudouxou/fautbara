-- lovable-cron-fallback-reviewed: 288 runs/day; reconciliation backstop for 15-minute payment holds
...
begin
  ...
  -- vérification de conflit et l'insertion qui suivent doivent être atomiques,
